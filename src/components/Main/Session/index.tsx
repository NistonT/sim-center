    ...
    <div className="mt-4 border border-[#e8eaec] border-b-0 rounded-xl rounded-b-none">
      ...
      <div className="max-h-[730px] overflow-y-scroll">
        {paginatedData.map((elem, index) => (
          <div
            key={elem.id}
            className={`grid grid-cols-[1fr_1fr_3fr_1fr_2fr_1fr] gap-4 p-4 ${index % 2 === 0 ? "bg-white" : "bg-gray-100"} border-b border-gray-200`}
          >
            ...
            <div className="font-manropeMedium font-medium text-[15px] leading-6 tracking-normal align-middle text-[#2f3144]">{elem.module}</div>
